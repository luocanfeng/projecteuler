...
def f():
    ...
    getNthFraction(arr, i)

def getNthFraction(arr, nth):
    isFirstItem = True
    ...
    for d in arr[::-1]:
        if isFirstItem:
            ...
            preNumerator, preDenominator = numerator, denominator
            denominator, numerator = preNumerator, d * preNumerator + preDenominator
